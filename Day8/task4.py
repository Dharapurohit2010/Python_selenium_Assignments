...
def runner():
    ...
    driver.find_element(By.XPATH, "//input[@id='id1']").send_keys("dhara")

    driver.find_element(By.XPATH, "//input[@id='id2']").send_keys("pandit")

    driver.find_element(By.XPATH, "//input[@id='id10']").send_keys("Project Manager")

    driver.find_element(By.XPATH, "//input[@id='id195']").send_keys("www.abc.com")

    driver.find_element(By.XPATH, "//input[@id='id3']").send_keys("abcdef")
